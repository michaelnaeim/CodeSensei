    ...
    <div className="max-w-3xl mx-auto py-8 px-5 space-y-8">
      ...
      <div className="panel p-6">
        ...
        <div className="grid md:grid-cols-2 gap-3">
          {[
            { title: "Component Hierarchy", desc: `${topicCount} nodes`, onClick: onSwitchToArchitecture },
            { title: "Data Flow", desc: `${Math.max(1, topicCount - 2)} nodes`, onClick: onSwitchToArchitecture },
            { title: "Dependencies", desc: `${topicCount} nodes`, onClick: onSwitchToArchitecture },
